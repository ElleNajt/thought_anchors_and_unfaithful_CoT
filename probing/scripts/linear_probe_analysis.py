...
def main():
    ...
    # Save results
    results_csv = os.path.join(DATA_DIR, 'linear_probe_results.csv')
    ...
    plot_probe_results(results_df, os.path.join(FIG_DIR, 'linear_probe_heatmap.png'))
    plot_layer_trends(results_df, os.path.join(FIG_DIR, 'linear_probe_layers.png'))
    plot_sentence_trends(results_df, os.path.join(FIG_DIR, 'linear_probe_sentences.png'))
    ...
    print("\nGenerated files:")
    print(f"  - {results_csv}")
    print(f"  - {os.path.join(FIG_DIR, 'linear_probe_heatmap.png')}")
    print(f"  - {os.path.join(FIG_DIR, 'linear_probe_layers.png')}")
    print(f"  - {os.path.join(FIG_DIR, 'linear_probe_sentences.png')}")
